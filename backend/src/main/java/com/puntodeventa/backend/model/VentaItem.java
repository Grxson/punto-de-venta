...
public class VentaItem {
    ...
    // Nombre completo del producto al momento de la venta (incluye variante si
    // aplica)
    ...
    // Costo total estimado del item (costo unitario estimado del producto *
    // cantidad).
     ...
     */
    @Column(name = "tamano_nombre", length = 100)
