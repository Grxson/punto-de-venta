...
// Lazy load chart components to prevent circular dependencies with Recharts
const AdminReportsChartsModule = lazy(() => import('./charts/AdminReportsCharts'));
                ...
                <Card>
                  <CardContent>
                    ...
                    <Suspense fallback={<CircularProgress />}>
                      <AdminReportsChartsModule.SalesVsGastosChart data={datosGraficaVentas} />
                    </Suspense>
                  </CardContent>
                </Card>
              </Box>
              ...
              <Box>
                <Card>
                  <CardContent>
                    ...
                    <Suspense fallback={<CircularProgress />}>
                      <AdminReportsChartsModule.Top5ProductosPieChart data={datosGraficaPie} />
                    </Suspense>
                  </CardContent>
                </Card>
              </Box>
              ...
              <Box sx={{ gridColumn: { xs: '1', md: '1 / -1' } }}>
                <Card>
                  <CardContent>
                    ...
                    <Suspense fallback={<CircularProgress />}>
                      <AdminReportsChartsModule.Top5ProductosPorUnidadesChart data={datosGraficaProductos} />
                    </Suspense>
                  </CardContent>
                </Card>
              </Box>
